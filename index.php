    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        if (isset($_FILES['archivos'])) {
            foreach ($_FILES['archivos']['tmp_name'] as $key => $tmp_name) {
                ...
                if (move_uploaded_file($fileTmpName, $carpetaRuta . '/' . $fileName)) {
                    $mensaje = "Archivo '$fileName' subido con éxito.";
                } else {
    ...
    <div class="content">
        ...
        <div class="container">
            <div class="drop-area" id="drop-area">
                <form action="" id="form" method="POST" enctype="multipart/form-data">
                    ...
                    <div id="progress-container" style="display: none;">
                        ...
                        <div id="progress-text">0% cargado</div>
                    </div>
            ...
            <div class="container2">
                <!-- Botones de "Descargar Todo" y "Eliminar Todos" colocados correctamente -->
                <form action="descargarTodo.php" method="POST" style="margin-top: 20px;">
                    <input type="hidden" name="nombre" value="<?php echo htmlspecialchars($carpetaNombre); ?>">
                    <button type="submit" class="Btn">Descargar Todo</button>
                </form>
                <form action="eliminarTodo.php" method="POST" style="margin-top: 10px;">
                    <input type="hidden" name="nombre" value="<?php echo htmlspecialchars($carpetaNombre); ?>">
                    <button type="submit" class="Btn">Eliminar Todos</button>
                </form>
